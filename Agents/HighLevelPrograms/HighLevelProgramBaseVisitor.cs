...
/// <summary>
/// This class provides an empty implementation of <see cref="IHighLevelProgramVisitor{Result}"/>,
...
public partial class HighLevelProgramBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IHighLevelProgramVisitor<Result> {
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitProgram([NotNull] HighLevelProgramParser.ProgramContext context) { return VisitChildren(context); }
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitPredicate([NotNull] HighLevelProgramParser.PredicateContext context) { return VisitChildren(context); }
