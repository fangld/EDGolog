...
namespace PAT.Common.Classes.SemanticModels.LTS.BDD
{
    public partial class AutomataBDD
    {
        ...
        public List<CUDDNode> priorityTransitionsBDD = new List<CUDDNode>(); 
        ...
        /// Sync Channel-in-based transitions
        /// </summary>
        public List<CUDDNode> prioritychannelIns = new List<CUDDNode>();
        ...
        /// Sync Channel-in-based transitions
        /// </summary>
        public List<CUDDNode> prioritychannelOuts= new List<CUDDNode>();
        ...
        {
            return new PrimitiveApplication(PrimitiveApplication.NOT_EQUAL, new VariablePrime(Model.EVENT_NAME),
