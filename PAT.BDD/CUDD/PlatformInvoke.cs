...
namespace PAT.Common.Classes.CUDDLib
{
    ...
    public class PlatformInvoke
    {
        ...
        [DllImport(@"CUDDHelper.dll")]
        public static extern IntPtr DD_InitialiseCUDD(int max_mem, int uniqueSlots, int cacheSlots, double epsilon);
        ...
        [DllImport(@"CUDDHelper.dll")]
        public static extern double DD_FindMinThreshold(IntPtr ddman, IntPtr dd, int threshold);

        [DllImport(@"CUDDHelper.dll")]
        public static extern double DD_FindMax(IntPtr ddman, IntPtr dd);

        [DllImport(@"CUDDHelper.dll")]
        public static extern double DD_FindMaxThreshold(IntPtr ddman, IntPtr dd, int threshold);
