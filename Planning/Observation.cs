...
namespace Planning
{
    public class Observation : ConstContainer
    {
        ...
        public Observation(PlanningParser.ObservationDefineContext context, IReadOnlyDictionary<string, Event> eventDict,
            string[] constArray, Dictionary<string, string> assignment)
            : base(constArray)
        {
            ...
            IReadOnlyDictionary<string, Event> eventDict, Dictionary<string, string> assignment)
        {
            ...
            if (context.LB() == null)
            {
                ...
                _eventCollectionArray[0] = GenerateEventCollection(context.gdEvent(), eventDict, assignment);
            ...
            else
            {
                ...
                _eventCollectionArray[0] = GenerateEventCollection(context.plGdEvent(0).gdEvent(), eventDict, assignment);
                ...
                _eventCollectionArray[1] = GenerateEventCollection(context.plGdEvent(1).gdEvent(), eventDict, assignment, 1);
