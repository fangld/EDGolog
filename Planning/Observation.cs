...
namespace Planning
{
    public class Observation : ConstContainer
    {
            ...
            IReadOnlyDictionary<string, Event> eventDict, Dictionary<string, string> assignment)
        {
            ...
            if (context.LB() == null)
            {
                ...
                _eventCollectionArray[0] = context.gdEvent().ToEventCollection(eventDict, assignment);
                    //ToEventCollection(context.gdEvent(), eventDict, assignment);
            ...
            else
            {
                ...
                _eventCollectionArray[0] = context.plGdEvent(0).gdEvent().ToEventCollection(eventDict, assignment);
                    //ToEventCollection(context.plGdEvent(0).gdEvent(), eventDict, assignment);
        ...
        //private EventCollection ToEventCollection(PlanningParser.GdEventContext context, IReadOnlyDictionary<string, Event> eventDict, Dictionary<string, string> assignment, int plDegree = 0)
        //{
