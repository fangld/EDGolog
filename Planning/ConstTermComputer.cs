...
namespace Planning
{
    public class ConstTermComputer
    {
        ...
        private Dictionary<string, int> _constValues;
        ...
        public void ShowInfo()
        {
            ...
            foreach (var pair in _constValues)
            {
